USE [ToyStore]
GO
/****** Object:  Table [dbo].[ChiTietHoaDon]    Script Date: 12/6/2021 1:47:28 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DoChoi]    Script Date: 12/6/2021 1:47:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[HoaDon]    Script Date: 12/6/2021 1:47:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Loai]    Script Date: 12/6/2021 1:47:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NhanVien]    Script Date: 12/6/2021 1:47:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[DoChoi] ([ID], [TenSanPham], [ID_Loai], [DoTuoi], [XuatXu], [ThuongHieu], [SoLuongTon], [GiaBan], [GiaNhap]) VALUES (1, N'Mô hình Bumblebee', 3, N'3 Tuổi trở lên', N'Việt Nam', N'TRANSFORMER', 30, 50000, 40000)
INSERT [dbo].[DoChoi] ([ID], [TenSanPham], [ID_Loai], [DoTuoi], [XuatXu], [ThuongHieu], [SoLuongTon], [GiaBan], [GiaNhap]) VALUES (2, N'Phòng Thí Nghiệm Của Gru', 4, N'12 Tuổi trở lên', N'Mỹ', N'LEGO MINIONS', 15, 120000, 100000)
INSERT [dbo].[DoChoi] ([ID], [TenSanPham], [ID_Loai], [DoTuoi], [XuatXu], [ThuongHieu], [SoLuongTon], [GiaBan], [GiaNhap]) VALUES (7, N'Công chúa Ariel', 5, N'3 - 9 Tuổi', N'Trung Quốc', N'DISNEY PRINCESS', 5, 30000, 15000)
INSERT [dbo].[DoChoi] ([ID], [TenSanPham], [ID_Loai], [DoTuoi], [XuatXu], [ThuongHieu], [SoLuongTon], [GiaBan], [GiaNhap]) VALUES (8, N'Pony bông', 6, N'3 Tuổi trở lên', N'Việt Nam', N'MY LITTLE PONY', 250, 90000, 80000)
